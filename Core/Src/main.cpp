...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
TMP116 tmp = TMP116(TMP116::I2CAddr::ADDR0);
/* USER CODE END 0 */
...
static void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(GPIOA, RST_OUT_Pin | EEPROM_WC_Pin, GPIO_PIN_SET);
	...
	/*Configure GPIO pins : LED1_Pin LED2_Pin LED3_Pin PM_FORCE_Pin
	 STOP_Pin EEPROM_WC_Pin */
	GPIO_InitStruct.Pin = LED1_Pin | LED2_Pin | LED3_Pin | PM_FORCE_Pin
			| STOP_Pin | EEPROM_WC_Pin;
	...
	/*Configure GPIO pins : FUSE_OC_Pin FUSE_OK_Pin PGOOD_Pin */
	GPIO_InitStruct.Pin = FUSE_OC_Pin | FUSE_OK_Pin | PGOOD_Pin;
